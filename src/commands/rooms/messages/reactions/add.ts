...
export default class MessagesReactionsAdd extends ChatBaseCommand {
  ...
  static override examples = [
    ...
    "$ ably rooms messages reactions add my-room message-serial 👍 --metadata '{\"source\":\"cli\"}'",
  ...
  static override flags = {
    ...
    metadata: Flags.string({
      description: "Additional metadata for the reaction (JSON format)",
    }),
  };
  ...
  async run(): Promise<void> {
    ...
    try {
      ...
      if (flags.type) {
        reactionParams.type = flags.type as MessageReactionType;
      }
      ...
      const resultData: MessageReactionResult = {
        ...
        ...(this.metadataObj && { metadata: this.metadataObj }),
      };
